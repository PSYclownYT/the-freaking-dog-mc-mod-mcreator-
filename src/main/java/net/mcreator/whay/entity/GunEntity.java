...
public class GunEntity extends AbstractArrow implements ItemSupplier {
	public GunEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(WhayModEntities.GUN.get(), world);
	}
	...
	public ItemStack getItem() {
		return new ItemStack(WhayModBlocks.ELMO_BLOCK.get());
	}
	...
	public static GunEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		GunEntity entityarrow = new GunEntity(WhayModEntities.GUN.get(), entity, world);
	...
	public static GunEntity shoot(LivingEntity entity, LivingEntity target) {
		GunEntity entityarrow = new GunEntity(WhayModEntities.GUN.get(), entity, entity.level());
